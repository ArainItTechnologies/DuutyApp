            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">We implement robust security measures to protect your personal data.</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="mr-4 mt-1">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">No Data Selling</h3>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-700">We're clear about what data we collect and how we use it.</p>
                </div>
              </div>
              <div className="flex items-start">
                <div className="mr-4 mt-1">
                ...
                <div>
                  ...
                  <p className="text-gray-700">You can access, modify, or delete your personal data at any time.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section>
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg">
              <p className="text-gray-700">Email: privacy@duuty.com</p>
              <p className="text-gray-700">Address: 123 Productivity Lane, Suite 100, San Francisco, CA 94103</p>
